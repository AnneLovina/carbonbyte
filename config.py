    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": "We prioritize transparency. In the Methodology section, you'll find a detailed explanation of all formulas, calculations, and data sources used.\nYou can find our full methodology here: [GitHub link]"
            }
        ]
    },
    {
        ...
        "questions": [
            {
                ...
                "answer": "Yes. The tool highlights where emissions occur and in what magnitude, helping you identify potential areas for reduction. These may include:\n- Using data centers powered by renewable energy\n- Optimizing server usage\n- Reducing data volumes\n- Using CDNs and caching"
            }
        ]
    },
    {
