class Parameter:
    ...
    LAPTOP_DEVICE_ON_POWER = 22  # Watt
    DESKTOP_DEVICE_ON_POWER = 115
    SMARTPHONE_DEVICE_ON_POWER = 1
    TABLET_DEVICE_ON_POWER = 6
    TV_DEVICE_ON_POWER = 100
    EREADER_DEVICE_ON_POWER = 1
